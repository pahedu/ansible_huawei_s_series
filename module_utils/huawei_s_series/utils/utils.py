...
def normalize_interface(name):
    ...
    if name.lower().startswith('ge') or name.lower().startswith('gigabitethernet'):
        if_type = 'GigabitEthernet'
    elif name.lower().startswith('xge') or name.lower().startswith('xgigabitethernet'):
...
def get_interface_type(interface):
    ...
    if interface.upper().startswith('GE') or interface.lower().startswith('gigabitethernet'):
        return 'GigabitEthernet'
    elif interface.upper().startswith('XGE') or interface.lower().startswith('xgigabitethernet'):
